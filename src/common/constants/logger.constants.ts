export const LOGGER_MESSAGES = {
  ...
  PASSWORD_CHANGE_SAME_OLD: 'Password change failed: New password cannot be the same as old password for user {userId}',
  PASSWORD_CHANGE_SAME_CURRENT: 'Password change failed: New password cannot be the same as current password for user {userId}',
  ...
  UPDATE_ADDRESS_NOT_FOUND_ADDRESS_AFTER: 'Update address failed: Address not found after update - {addressId}',
